----Tao CSDL
if exists (select name from master..sysdatabases where name = 'FS')
use master
drop database FS
go
create database FS
...
(
	name = FS_Dat,
	filename = 'C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\Data\FS.mdf',
	size = 3,
	maxsize = 10,
	filegrowth = 1
)
...
(
	name = FS_Log,
	filename = 'C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\Data\FS.ldf',
	size = 3,
	maxsize = 5,
	filegrowth = 1
)
